...
def get_news_by_week(past_n_week=5, n_recent=20) -> Tuple[pd.DataFrame, dict]:
...
def get_news_by_week_df(past_n_week=5, n_recent=20) -> Tuple[pd.DataFrame, pd.DataFrame]:
    """Accumulate and sort by time al the articles from the most recent weeks 
